...
/**
 * Platonus 6.26 web (Angular /v7) student schedule.
...
export function journalRecordsPaths(
  ...
  return [
    `rest/mobile/journal/records/${year}/${term}?subjectID=${subjectId}`,
    `rest/mobile/journal/records/${year}/${term}?SubjectID=${subjectId}`,
    `rest/mobile/journal/records/${year}/${term}/${subjectId}`,
    `rest/mobile/journal/records/${year}/${term}/${subjectId}/${lang}`,
    `rest/mobile/journal/${year}/${term}/${subjectId}/${lang}`,
    `rest/api/journal/records/${year}/${term}?subjectID=${subjectId}`,
    `rest/api/journal/records/${year}/${term}?SubjectID=${subjectId}`,
    `rest/api/journal/${year}/${term}/${lang}/${subjectId}`,
    `rest/api/journal/subject/${subjectId}/${year}/${term}/${lang}`,
    `rest/journal/records/${year}/${term}?subjectID=${subjectId}`,
    `rest/journal/student/records/${year}/${term}/${subjectId}`,
    `rest/mobile/gradebook/records/${year}/${term}?subjectID=${subjectId}`,
    `rest/gradebook/student/${subjectId}/${year}/${term}/${lang}`,
  ];
}
